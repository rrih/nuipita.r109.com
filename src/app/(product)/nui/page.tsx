...
export default function Nui(){
  ...
  return <>
    ...
    <section className="hero"><Image src={selectedShapeImage} alt={`${shapeOptions.find(([value])=>value===shape)?.[1]}のぬいイメージ`} width={112} height={112}/><h2>うちのぬいを登録</h2><p className="small">最初に1体登録すると、服やポーチの判定で毎回選べます。</p></section>
