...
export const metadata:Metadata={metadataBase:new URL(siteConfig.url),title:{default:"ぬい服サイズチェッカー｜ぬいぴた",template:"%s｜ぬいぴた"},description:"ぬいぐるみとぬい服の寸法から、頭・胴・丈のフィット感を確認。採寸カルテとぬいポーチ内寸シミュレーターも無料で使えます。",manifest:"/manifest.webmanifest",icons:{icon:"/favicon-v3.png",apple:"/apple-touch-icon-v3.png"},openGraph:{siteName:siteConfig.name,locale:"ja_JP",type:"website",url:siteConfig.url,images:[{url:"/og/site",width:1200,height:630,type:"image/png",alt:"ぬいぴた"}]},twitter:{card:"summary_large_image",images:["/og/site"]},alternates:{canonical:"/"},robots:{index:true,follow:true},formatDetection:{telephone:false},appleWebApp:{capable:true,title:siteConfig.name,statusBarStyle:"default"}};
