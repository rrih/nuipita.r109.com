...
const images:Record<GarmentType,string>={pullover:"/garments/pullover.png",frontOpen:"/garments/front-open.png",bottoms:"/garments/bottoms.png",onePiece:"/garments/one-piece.png",headwear:"/garments/hat.png"};
