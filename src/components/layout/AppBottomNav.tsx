...
type NavIconProps={name:"profile"|"clothes"|"pouch"};
...
export function AppBottomNav(){
  ...
  const activeIndex=pathname.startsWith("/g/")||pathname==="/"?1:pathname==="/nui"?0:pathname==="/pouch"?2:-1;const width=100/tabs.length;
